...
def update_last_run(current_run, num_view_updates, num_new_updates, updates):
    log = dict()
...
def get_last_run():
    try:
        with open('pagerduty-log.json', 'r') as json_data:  
...
if __name__=='__main__':
    config = config_parse(sys.argv[-1])
    main()
